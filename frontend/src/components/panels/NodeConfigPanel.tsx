...
const NodeConfigPanel: React.FC = () => {
  ...
  useEffect(() => {
    ...
    api.get<any>('/knowledge/directories')
    ...
    switch (nodeType) {
        ...
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>变量名</Text>
              <Input size="small" placeholder="例如: user_input"
                value={config.variable_name || ''}
                onChange={(e) => updateConfig('variable_name', e.target.value)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>输入类型</Text>
      ...
      case 'llm':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>模型</Text>
              <Select size="small" style={{ width: '100%' }}
                value={config.model || ''}
            ...
            <PromptEditor label="系统提示词" value={config.system_prompt || ''}
              onChange={(v) => updateConfig('system_prompt', v)} variables={['input.*']} />
            <PromptEditor label="用户提示词" value={config.prompt || ''}
              onChange={(v) => updateConfig('prompt', v)} variables={['input.*']} />
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>温度</Text>
              <InputNumber size="small" min={0} max={2} step={0.1} style={{ width: '100%' }}
                value={config.temperature ?? 0.7} onChange={(v) => updateConfig('temperature', v)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>最大 Token</Text>
              <InputNumber size="small" min={1} max={128000} step={100} style={{ width: '100%' }}
                value={config.max_tokens ?? 4096} onChange={(v) => updateConfig('max_tokens', v)} />
            </div>
          </>
        );
      ...
      case 'knowledge-retrieval':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>知识库目录</Text>
              <Select size="small" style={{ width: '100%' }}
                value={config.knowledge_base || ''}
                onChange={(v) => updateConfig('knowledge_base', v)}
                placeholder="选择知识库目录">
                {directories.map(d => (
            ...
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>查询文本</Text>
              <TextArea size="small" rows={3} placeholder="输入查询内容..."
                value={config.query || ''}
                onChange={(e) => updateConfig('query', e.target.value)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>返回条数 (Top-K)</Text>
              <InputNumber size="small" min={1} max={100} style={{ width: '100%' }}
                value={config.top_k ?? 5} onChange={(v) => updateConfig('top_k', v)} />
            </div>
          </>
        );
      ...
      case 'template':
        return (
          <div style={{ marginBottom: 12 }}>
            <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>模板内容</Text>
      ...
      case 'code':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>编程语言</Text>
              <Select size="small" style={{ width: '100%' }}
            ...
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>代码</Text>
              <TextArea size="small" rows={8} placeholder="输入要执行的代码..."
                value={config.code || ''}
      ...
      case 'ifelse':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>条件表达式</Text>
              <TextArea size="small" rows={3} placeholder={'例如: {{score}} > 0.5'}
                value={config.condition || ''}
                onChange={(e) => updateConfig('condition', e.target.value)}
                style={{ fontFamily: 'monospace', fontSize: 12 }} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>True 分支标签</Text>
              <Input size="small" placeholder="True"
                value={config.true_label || ''}
                onChange={(e) => updateConfig('true_label', e.target.value)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>False 分支标签</Text>
              <Input size="small" placeholder="False"
      ...
      case 'output':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>输出类型</Text>
              <Select size="small" style={{ width: '100%' }}
            ...
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>输出文件名</Text>
              <Input size="small" placeholder="例如: result.json"
      ...
      case 'http-request':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>请求方法</Text>
              <Select size="small" style={{ width: '100%' }}
            ...
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>URL</Text>
              <Input size="small" placeholder="https://api.example.com/endpoint"
                value={config.url || ''}
                onChange={(e) => updateConfig('url', e.target.value)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>请求头 (JSON)</Text>
              <TextArea size="small" rows={3} placeholder='{"Authorization": "Bearer xxx"}'
      ...
      case 'human-input':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>提示文本</Text>
              <TextArea size="small" rows={4} placeholder="向用户展示的提示内容"
      ...
      case 'iteration':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>集合变量</Text>
              <Input size="small" placeholder="例如: items"
                value={config.collection || ''}
                onChange={(e) => updateConfig('collection', e.target.value)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>迭代变量名</Text>
              <Input size="small" placeholder="例如: item"
                value={config.item_variable || ''}
                onChange={(e) => updateConfig('item_variable', e.target.value)} />
            </div>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>最大迭代次数</Text>
              <InputNumber size="small" min={1} max={1000} style={{ width: '100%' }}
                value={config.max_iterations ?? 100} onChange={(v) => updateConfig('max_iterations', v)} />
            </div>
          </>
        );
      ...
      case 'doc-extractor':
        return (
          <>
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>文件格式</Text>
              <Select size="small" style={{ width: '100%' }}
            ...
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>文件路径</Text>
              <Input size="small" placeholder="例如: /path/to/document.pdf"
      ...
      case 'variable-aggregator':
        return (
          <div style={{ marginBottom: 12 }}>
            <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>源分支配置 (JSON)</Text>
            <TextArea size="small" rows={6}
              placeholder={JSON.stringify([{ node_id: 'node_xxx', alias: 'branch_a' }], null, 2)}
              value={(() => { try { return JSON.stringify(config.sources || [], null, 2); } catch { return ''; } })()}
              onChange={(e) => { try { const v = JSON.parse(e.target.value); if (Array.isArray(v)) updateConfig('sources', v); } catch {} }}
              style={{ fontFamily: 'monospace', fontSize: 12 }} />
          </div>
        );
        ...
        return (
          <>
            ...
            <PromptEditor label="系统提示词" value={config.system_prompt || ''}
              onChange={(v) => updateConfig('system_prompt', v)} variables={['input.*']} />
            <div style={{ marginBottom: 12 }}>
              <Text strong style={{ fontSize: 12, display: 'block', marginBottom: 4 }}>工具配置 (JSON)</Text>
              <TextArea size="small" rows={5}
                placeholder={JSON.stringify([{ name: 'search', description: '搜索工具', parameters: {} }], null, 2)}
                value={(() => { try { return JSON.stringify(config.tools || [], null, 2); } catch { return ''; } })()}
                onChange={(e) => { try { const v = JSON.parse(e.target.value); if (Array.isArray(v)) updateConfig('tools', v); } catch {} }}
                style={{ fontFamily: 'monospace', fontSize: 12 }} />
            </div>
          </>
        );
        ...
        return (
          <>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <TextArea size="small" rows={3} placeholder='{"source_field": "target_field"}'
      ...
      default:
        return <Text type="secondary" style={{ fontSize: 12 }}>节点类型 "{nodeType}" 暂无配置选项</Text>;
    }
  };
